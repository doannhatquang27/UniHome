...
import "../Five/index.scss";

interface Props {
  imageList: string[];
}

const FivePlusImageGrid: React.FC<Props> = ({ imageList }) => {
  ...
  return (
    <div className="five-grid">
      <Grid container direction="row">
        <Grid item xs={8} style={{ padding: 1 }} className="first">
          <CustomImage
            source={imageList[0]}
            isMain
          ...
          <Grid container direction="column">
            <Grid item xs={12}>
              <Grid container direction="row">
                ...
                <Grid item xs={6} style={{ padding: 1 }} className="third">
                  <CustomImage
                    source={imageList[2]}
                    handleToggle={handleToggle}
...
export default FivePlusImageGrid;
