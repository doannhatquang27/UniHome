      ...
      <Grid container direction="row">
        <Grid item xs={6}>
          <Grid container direction="column">
            <Grid item xs={12} style={{ padding: 1 }} className="first">
              <CustomImage
                source={imageList[0]}
            ...
            <Grid item xs={12} style={{ padding: 1 }} className="second">
              <CustomImage
                source={imageList[1]}
                handleToggle={handleToggle}
        ...
        <Grid item xs={6}>
          <Grid container direction="column">
            <Grid item xs={12} style={{ padding: 1 }} className="third">
              <CustomImage
                source={imageList[2]}
                handleToggle={handleToggle}
            ...
            <Grid item xs={12} style={{ padding: 1 }} className="forth">
              <CustomImage
                source={imageList[3]}
                handleToggle={handleToggle}
